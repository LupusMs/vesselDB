#############################################################################
# Makefile for building: vesselDB
# Generated by qmake (3.1) (Qt 5.12.4)
# Project:  vesselDB.pro
# Template: subdirs
# Command: /usr/lib/qt5/bin/qmake -o Makefile vesselDB.pro CONFIG+=debug
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = vesselDB1.0.0
DISTDIR = /storage/WebApp/vesselDB/.tmp/vesselDB1.0.0
SUBTARGETS    =  \
		sub-helpers \
		sub-models \
		sub-views \
...
sub-helpers-qmake_all:  FORCE
	...
	cd helpers/ && $(QMAKE) -o Makefile /storage/WebApp/vesselDB/helpers/helpers.pro CONFIG+=debug
	cd helpers/ && $(MAKE) -f Makefile qmake_all
sub-helpers: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/helpers/helpers.pro CONFIG+=debug ) && $(MAKE) -f Makefile
...
sub-helpers-all-ordered: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/helpers/helpers.pro CONFIG+=debug ) && $(MAKE) -f Makefile all
sub-helpers-all: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/helpers/helpers.pro CONFIG+=debug ) && $(MAKE) -f Makefile all
sub-helpers-clean-ordered: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/helpers/helpers.pro CONFIG+=debug ) && $(MAKE) -f Makefile clean
sub-helpers-clean: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/helpers/helpers.pro CONFIG+=debug ) && $(MAKE) -f Makefile clean
sub-helpers-distclean-ordered: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/helpers/helpers.pro CONFIG+=debug ) && $(MAKE) -f Makefile distclean
sub-helpers-distclean: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/helpers/helpers.pro CONFIG+=debug ) && $(MAKE) -f Makefile distclean
sub-helpers-install_subtargets-ordered: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/helpers/helpers.pro CONFIG+=debug ) && $(MAKE) -f Makefile install
sub-helpers-install_subtargets: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/helpers/helpers.pro CONFIG+=debug ) && $(MAKE) -f Makefile install
sub-helpers-uninstall_subtargets-ordered: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/helpers/helpers.pro CONFIG+=debug ) && $(MAKE) -f Makefile uninstall
sub-helpers-uninstall_subtargets: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/helpers/helpers.pro CONFIG+=debug ) && $(MAKE) -f Makefile uninstall
sub-models-qmake_all: sub-helpers-qmake_all FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && $(QMAKE) -o Makefile /storage/WebApp/vesselDB/models/models.pro CONFIG+=debug
	cd models/ && $(MAKE) -f Makefile qmake_all
sub-models: FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/models/models.pro CONFIG+=debug ) && $(MAKE) -f Makefile
...
sub-models-all-ordered: sub-helpers-all-ordered  FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/models/models.pro CONFIG+=debug ) && $(MAKE) -f Makefile all
sub-models-all: FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/models/models.pro CONFIG+=debug ) && $(MAKE) -f Makefile all
sub-models-clean-ordered: sub-helpers-clean-ordered  FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/models/models.pro CONFIG+=debug ) && $(MAKE) -f Makefile clean
sub-models-clean: FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/models/models.pro CONFIG+=debug ) && $(MAKE) -f Makefile clean
sub-models-distclean-ordered: sub-helpers-distclean-ordered  FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/models/models.pro CONFIG+=debug ) && $(MAKE) -f Makefile distclean
sub-models-distclean: FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/models/models.pro CONFIG+=debug ) && $(MAKE) -f Makefile distclean
sub-models-install_subtargets-ordered: sub-helpers-install_subtargets-ordered  FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/models/models.pro CONFIG+=debug ) && $(MAKE) -f Makefile install
...
sub-models-uninstall_subtargets-ordered: sub-helpers-uninstall_subtargets-ordered  FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/models/models.pro CONFIG+=debug ) && $(MAKE) -f Makefile uninstall
sub-models-uninstall_subtargets: FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/models/models.pro CONFIG+=debug ) && $(MAKE) -f Makefile uninstall
sub-views-qmake_all: sub-models-qmake_all FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && $(QMAKE) -o Makefile /storage/WebApp/vesselDB/views/views.pro CONFIG+=debug
	cd views/ && $(MAKE) -f Makefile qmake_all
sub-views: FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/views/views.pro CONFIG+=debug ) && $(MAKE) -f Makefile
...
sub-views-all-ordered: sub-models-all-ordered  FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/views/views.pro CONFIG+=debug ) && $(MAKE) -f Makefile all
sub-views-all: FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/views/views.pro CONFIG+=debug ) && $(MAKE) -f Makefile all
sub-views-clean-ordered: sub-models-clean-ordered  FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/views/views.pro CONFIG+=debug ) && $(MAKE) -f Makefile clean
sub-views-clean: FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/views/views.pro CONFIG+=debug ) && $(MAKE) -f Makefile clean
sub-views-distclean-ordered: sub-models-distclean-ordered  FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/views/views.pro CONFIG+=debug ) && $(MAKE) -f Makefile distclean
sub-views-distclean: FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/views/views.pro CONFIG+=debug ) && $(MAKE) -f Makefile distclean
sub-views-install_subtargets-ordered: sub-models-install_subtargets-ordered  FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/views/views.pro CONFIG+=debug ) && $(MAKE) -f Makefile install
sub-views-install_subtargets: FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/views/views.pro CONFIG+=debug ) && $(MAKE) -f Makefile install
sub-views-uninstall_subtargets-ordered: sub-models-uninstall_subtargets-ordered  FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/views/views.pro CONFIG+=debug ) && $(MAKE) -f Makefile uninstall
...
sub-controllers-qmake_all: sub-views-qmake_all FORCE
	...
	cd controllers/ && $(QMAKE) -o Makefile /storage/WebApp/vesselDB/controllers/controllers.pro CONFIG+=debug
	cd controllers/ && $(MAKE) -f Makefile qmake_all
sub-controllers: FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/controllers/controllers.pro CONFIG+=debug ) && $(MAKE) -f Makefile
...
sub-controllers-all-ordered: sub-views-all-ordered  FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/controllers/controllers.pro CONFIG+=debug ) && $(MAKE) -f Makefile all
sub-controllers-all: FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/controllers/controllers.pro CONFIG+=debug ) && $(MAKE) -f Makefile all
sub-controllers-clean-ordered: sub-views-clean-ordered  FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/controllers/controllers.pro CONFIG+=debug ) && $(MAKE) -f Makefile clean
sub-controllers-clean: FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/controllers/controllers.pro CONFIG+=debug ) && $(MAKE) -f Makefile clean
sub-controllers-distclean-ordered: sub-views-distclean-ordered  FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/controllers/controllers.pro CONFIG+=debug ) && $(MAKE) -f Makefile distclean
sub-controllers-distclean: FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/controllers/controllers.pro CONFIG+=debug ) && $(MAKE) -f Makefile distclean
sub-controllers-install_subtargets-ordered: sub-views-install_subtargets-ordered  FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/controllers/controllers.pro CONFIG+=debug ) && $(MAKE) -f Makefile install
...
sub-controllers-uninstall_subtargets-ordered: sub-views-uninstall_subtargets-ordered  FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/controllers/controllers.pro CONFIG+=debug ) && $(MAKE) -f Makefile uninstall
sub-controllers-uninstall_subtargets: FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/controllers/controllers.pro CONFIG+=debug ) && $(MAKE) -f Makefile uninstall

Makefile: vesselDB.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		vesselDB.pro
	$(QMAKE) -o Makefile vesselDB.pro CONFIG+=debug
...
sub-helpers-check_ordered:
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/helpers/helpers.pro CONFIG+=debug ) && $(MAKE) -f Makefile check
sub-models-check_ordered: sub-helpers-check_ordered 
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/models/models.pro CONFIG+=debug ) && $(MAKE) -f Makefile check
sub-views-check_ordered: sub-models-check_ordered 
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/views/views.pro CONFIG+=debug ) && $(MAKE) -f Makefile check
sub-controllers-check_ordered: sub-views-check_ordered 
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/controllers/controllers.pro CONFIG+=debug ) && $(MAKE) -f Makefile check
...
sub-helpers-benchmark_ordered:
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/helpers/helpers.pro CONFIG+=debug ) && $(MAKE) -f Makefile benchmark
sub-models-benchmark_ordered: sub-helpers-benchmark_ordered 
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/models/models.pro CONFIG+=debug ) && $(MAKE) -f Makefile benchmark
sub-views-benchmark_ordered: sub-models-benchmark_ordered 
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/views/views.pro CONFIG+=debug ) && $(MAKE) -f Makefile benchmark
sub-controllers-benchmark_ordered: sub-views-benchmark_ordered 
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) -o Makefile /storage/WebApp/vesselDB/controllers/controllers.pro CONFIG+=debug ) && $(MAKE) -f Makefile benchmark
